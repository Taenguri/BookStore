...
<script>
	...
	function order_list(f) {
		window
				.open(
						"detail_page.do?deliveryname=${param.deliveryname}&deliverytel1=${param.deliverytel1}&deliverytel2=${param.deliverytel2}&deliverytel3=${param.deliverytel3}&deliverypostcode=${param.deliverypostcode}&deliveryaddress1=${param.deliveryaddress2}&deliveryaddress2=${param.deliveryaddress2}",
