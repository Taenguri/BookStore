                                            ...
                                            <div class="view_content">
                                                  ...
                                                  <div class="jungo_button_area">
												          <c:if test="${id == jungobook.id}">
                                                           ...
                                                           onclick="location.href= '/bookListJungo?c=${param.c}&t=${param.t}&page=${search.page}&countPerPage=${search.countPerPage}';">목록</button> 
                                                  </div>       
...
// 상품 수량정하기
  ...
  if(con) {      
   formObj.attr("action", "/jungodelete");
   formObj.submit();
  }
 });  
  ...
  $("#modify_Btn").click(function(){
		var formObj = $("form[name='contentForm']");  
   formObj.attr("action", "/jungomodify");
